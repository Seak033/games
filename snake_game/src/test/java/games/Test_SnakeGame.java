...
public class Test_SnakeGame extends JPanel implements KeyListener, ActionListener {
    ...
    public Test_SnakeGame(Image backgroundImage) {
    ...
    public void keyPressed(KeyEvent e) {   
        ...
        if (!gameStarted && e.getKeyCode() == KeyEvent.VK_H) {
            ...
            Test_Home homescreen = new Test_Home();
            homescreen.homePage();
        }
